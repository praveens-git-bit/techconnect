...
13. Since the data has already been normalized lets comment out function used for featurization, scroll down in the Notebook to the **Step 2: Featurization** section. Locate cell number 2 within this section, and comment out lines 10 and 11 by adding **#** at the beginning of each line, as shown in the screenshot.
